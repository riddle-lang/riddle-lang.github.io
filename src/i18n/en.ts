...
export const en: SiteContent = {
  ...
  hero: {
    badge: 'v0.1.1 · Technology preview',
    title: 'Memory safety,',
    ...
    items: [
      {
        ...
        usage: 'riddlec [--verbose] [--backend c] [--output <file>] <file>...',
        points: [
      ...
      },
      {
        ...
        usage: 'clue init | new | check | build | run',
        points: [
...
clue run`,
  ...
  status: {
    ...
    subtitle:
      'The v0.1.1 language and toolchain may still change incompatibly. Here is the honest boundary of what works.',
