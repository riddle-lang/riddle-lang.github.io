...
export const en: SiteContent = {
  ...
  hero: {
    badge: 'v0.2.1 · Technology preview',
    title: 'Memory safety,',
...
void rgc_collect(void);`,
  ...
  release: {
    eyebrow: 'What\'s new in v0.2.1',
    title: 'A richer editor and compiler experience',
    subtitle:
      'This release fills out LSP navigation and rename support, expands procedural macros and formatting, and gives the compiler clearer internal layers and diagnostics.',
    items: [
      {
        title: 'A fuller LSP',
        desc: 'Hover, go to definition and implementation, references, prepare rename, rename, formatting, workspace indexing and automatic imports are now supported.',
      },
      {
        title: 'Procedural macro support',
        desc: 'Proc macros now cover package discovery, derive / function / attribute exports, source mapping, diagnostics, token-stream expansion, caching and long-lived workers.',
      },
      {
        title: 'Tuples and compiler layers',
        desc: 'Tuple types and lowering are implemented, and the compiler is split into syntax, type, HIR, MIR and workspace layers; cross-crate tests now live under the root target.',
      },
      {
        title: 'Formatting and standard macros',
        desc: 'Rust-style formatting and token-quoting macros are supported; `panic!`, `assert!`, `todo!` and related macros now share formatting, source locations and abort diagnostics.',
      },
    ],
  },
  toolchain: {
...
clue run`,
  ...
  status: {
    ...
    subtitle:
      'The v0.2.1 language and toolchain may still change incompatibly. Here is the honest boundary of what works.',
