...
void rgc_collect(void);`,
  ...
  release: {
    eyebrow: 'v0.2.1 新内容',
    title: '更完整的编辑器与编译器体验',
    subtitle: '这一版补齐 LSP 导航与重命名，扩展过程宏和格式化能力，并让编译器结构与诊断更完整。',
    items: [
      {
        title: '更完整的 LSP',
        desc: '支持 Hover、跳转定义与实现、查找引用、准备重命名、重命名、格式化、工作区索引和自动导入。',
      },
      {
        title: '过程宏能力扩展',
        desc: '支持过程宏包发现、derive / function / attribute 导出、源码映射、诊断、TokenStream 展开、缓存和长驻 worker。',
      },
      {
        title: '元组与编译器分层',
        desc: '元组类型与降级已实现，编译器拆分为语法、类型、HIR、MIR 和工作区层，跨 crate 集成测试归入根测试目标。',
      },
      {
        title: '格式化与标准宏',
        desc: '支持 Rust 风格格式化和 token-quoting 宏；`panic!`、`assert!`、`todo!` 等宏统一格式化、源码位置和终止诊断。',
      },
    ],
  },
  toolchain: {
...
clue run`,
  ...
  status: {
    eyebrow: '项目状态',
    title: '这是技术预览，我们不藏着',
    subtitle: 'v0.2.1 的语言和工具链仍可能发生不兼容变化。下面是当前真实的能力边界。',
    worksTitle: '已经可用',
    works: [
